    ...
    <section className={`relative w-full ${height} flex flex-col justify-center items-center ${backgroundColor} p-32 px-10 ${className}`}>
      {flower && (
        <div className={`w-full h-full overflow-hidden absolute z-0`}>
          ...
          <img src="/images/bunga3.png" alt="" className="absolute -top-9 -left-5 w-[60dvw] max-w-64 z-0" />
          <img src="/images/bunga4.png" alt="" className="absolute -top-[8rem] -right-10 w-[60dvw] max-w-64 z-0 rotate-[110deg]" />

          <img src="/images/bunga3.png" alt="" className="absolute -bottom-9 -right-5 w-[60dvw] max-w-64 z-0 rotate-180" />
          <img src="/images/bunga4.png" alt="" className="absolute -bottom-[7.5rem] -left-10 w-[60dvw] max-w-64 z-0 rotate-[-65deg]" />
        </div>
      )}
